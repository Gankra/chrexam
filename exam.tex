...
\begin{parts}
\part[4] Prove that if $x$ is even, $(x + 1)^2$ is odd
\vfill



\part[4] Prove that if $x$ is odd, $(x + 1)^2$ is even
\vfill
...
\part[3] Assuming the surface of the cat's eye is perpendicular to its brain,
